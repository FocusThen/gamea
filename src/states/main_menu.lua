...
function mainMenuScene:drawSettingsScreen()
	...
	for i = 1, 3 do
		...
		if isPlusSelected then
			...
			love.graphics.rectangle("fill", plusX - Constants.MENU.SETTINGS_BUTTON_PADDING, y - 1, Constants.MENU.SETTINGS_BUTTON_WIDTH, Constants.MENU.SETTINGS_BUTTON_HEIGHT)
		end
		love.graphics.setColor(1, 1, 1, 1)
		...
		if isMinusSelected then
			love.graphics.setColor(0, 1, 1, 1) -- Cyan highlight
			love.graphics.rectangle("fill", minusX - Constants.MENU.SETTINGS_BUTTON_PADDING, y - 1, Constants.MENU.SETTINGS_BUTTON_WIDTH, Constants.MENU.SETTINGS_BUTTON_HEIGHT)
		end
		love.graphics.setColor(1, 1, 1, 1)
	...
	love.graphics.setColor(1, 1, 1, 1)
	local textWidth = fonts.default:getWidth(crtText)
	love.graphics.print(crtText, fonts.default,
		gameSettings.gameWidth / 2 - textWidth / 2,
		crtY
	)
